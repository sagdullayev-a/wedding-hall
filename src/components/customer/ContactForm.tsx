  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      >
        ...
        <p className="text-muted-foreground">Savollaringiz bormi? Biz doimo yordam berishga tayyormiz!</p>
      </motion.div>
              ...
              <CardContent className="p-0">
                <div className="h-40 bg-gradient-to-br from-rose-100 via-amber-50 to-rose-50 dark:from-rose-900/20 dark:via-amber-900/10 dark:to-rose-900/20 flex items-center justify-center relative">
                  ...
                  <div className="text-center relative">
                    ...
                    <p className="text-sm font-semibold text-rose-700 dark:text-rose-300">Toshkent, O'zbekiston</p>
                    <p className="text-xs text-rose-500/70 dark:text-rose-400/70">Amir Temur ko'chasi, 107A</p>
                  </div>
                </div>
              </CardContent>
            </Card>
